...
class Ui_dlgMain(object):
    def setupUi(self, dlgMain):
        ...
        self.layForm.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.lblComments)
        self.commentsLineEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.commentsLineEdit.setObjectName("commentsLineEdit")
        self.layForm.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.commentsLineEdit)
        ...
        self.layForm.setLayout(5, QtWidgets.QFormLayout.SpanningRole, self.horizontalLayout)
        ...
        self.dsbEnterSugar.setSingleStep(0.1)
        ...
        self.lblInsulin = QtWidgets.QLabel(self.centralwidget)
        self.lblInsulin.setObjectName("lblInsulin")
        self.layForm.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.lblInsulin)
        self.spbInsulin = QtWidgets.QSpinBox(self.centralwidget)
        self.spbInsulin.setProperty("value", 10)
        self.spbInsulin.setObjectName("spbInsulin")
        self.layForm.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.spbInsulin)
    ...
    def retranslateUi(self, dlgMain):
        ...
        dlgMain.setWindowTitle(_translate("dlgMain", "Measuring Sugar "))
        ...
        self.lblInsulin.setText(_translate("dlgMain", "Insulin"))
        self.spbInsulin.setSuffix(_translate("dlgMain", " Units"))
